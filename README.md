# Data Science Portfolio - ``cscheiding``

Welcome to my Data Science portfolio. This repository contains a collection of projects that showcase my skills in **Machine Learning using Python**. Each folder corresponds to an individual project, with its own Jupyter Notebook.
...
- **Dimensionality Reduction with Neural Networks for Predictive Analysis of Fraudulent Job Ads** (English 🇺🇸)  
  ...
  [View Project](./3%20Fraudulent%20Job%20Ads%20Detection)
...
- **Credit Risk Analysis** (English 🇺🇸)  
  ...
  [View Project](./2%20Credit%20Risk%20Analysis)
...
- **Stellar Age Prediction (Predicción de edades estelares)** (Spanish 🇪🇸)  
  ...
  [View Project](./1%20Stellar%20Age%20Prediction)
